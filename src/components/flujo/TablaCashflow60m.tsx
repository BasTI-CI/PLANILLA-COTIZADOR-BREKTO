  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
      ...
      <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', fontSize: 10 }}>
        {[
          { color: COLOR_MES_ENTREGA, label: '🔑 Mes(es) entrega' },
          { color: COLOR_MES_IVA, label: '💰 Dev. IVA (M entrega + 5)' },
          { color: COLOR_PRE_ENTREGA, label: '📋 Pre entrega (pie)' },
          { color: COLOR_MIXED, label: '🔀 Fase mixta' },
          { color: COLOR_POST_ENTREGA, label: '🏠 Post entrega' },
        ].map(({ color, label }) => (
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', tableLayout: 'fixed' }}>
          ...
          <tbody>
            {tabla.map((f) => {
              ...
              return (
                <tr key={f.mes} style={rowStyle(f.mes, mesesEntrega, mesesIVA)}>
      ...
      <div>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <tbody>
            ...
            <tr style={{ background: 'rgba(212,168,67,0.12)', borderTop: '2px solid rgba(212,168,67,0.35)' }}>
              <td style={{ ...tdBase, fontWeight: 800, color: 'var(--color-gold)', textAlign: 'center', fontSize: 12 }}>RESUMEN TOTAL (60 m.)</td>
              <td style={{ ...tdBase, fontWeight: 800, color: 'var(--color-gold)' }}>{fmtCLP(t60.capitalFin)}</td>
        ...
        {resumenContexto && (
          ...
          >
            <div style={{ fontWeight: 700, color: 'var(--color-gold)', marginBottom: 6, fontSize: pdfMode ? 10 : 12 }}>
